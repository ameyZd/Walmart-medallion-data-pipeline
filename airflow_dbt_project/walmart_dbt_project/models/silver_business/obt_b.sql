{% set configs = [
    ...
    {
        "table": "walmart.silver_technical.orders_t",
        "columns":"""o.order_id,
                        o.store_id,
                        o.order_timestamp,
                        o.payment_method,
    ...
    {
        "table": "walmart.silver_technical.customers_t",
    ...
    {
        "table": "walmart.silver_technical.order_items_t",
    ...
    {
        "table": "walmart.silver_technical.products_t",
    ...
    {
        "table": "walmart.silver_technical.employees_t",
    ...
    {
        "table": "walmart.silver_technical.stores_t",
